...
Last updated: July 20, 2026 (Session 106 — CAPTURE DAY ✅: dual-sim (iPhone 17 Pro EN / iPhone 17 FR, one Metro), fresh-flag rebuilds, demo account re-seeded + re-activated per device (S105 chain re-proven). ALL 15 in-app §22 figures F02–F16 captured EN+FR (105-file inventory, terminal-proven) + F00 signup-state series. Group C: 6 live UAT sends → 6× WS0000, 0 bounces (CONF 163581 logbook-EN / 163582 logbook-FR / 163583 222-EN / 163584 222-FR / 163585 233-EN / 163586 233-FR; all XSD Passed, fresh filenames). Findings ruled: F06 doc-vs-app (no Settings row — entry is the header pill; §22 §4.1 rewrite at integration), profile-post-activation flow (§22 §3/§4 reorder; hint-text reword → Aug/Sept), seed date amended to 2026-07-19 (Confirm Trip Start auto-stamps), 222 logbook-ref auto-gen noted, two signup throwaways three-surfaces deleted. F01 store listing still external/pending. Session-open housekeeping: S105 gate-doc tightening committed standalone as 7fc4545. Full record docs/GATE_S106_CAPTURE.md. NO-GIT: commit block in GATE_S106_CAPTURE.md §7 (Jonny runs; hash PENDING VERIFICATION). PRIOR: Session 105 — dfoelog demo account setup (role dfo, MAR-90 profile, free-activated); §22/TRG capture unblocked; docs/GATE_S105_DEMO_ACCOUNT.md. Next — SESSION 107 TBD)
...
SESSION 107 — TBD. Likely: Kane-deadline outcome (reply vs folder recon + RFQ Id determination), figures → Drive masters + §22 edit pass (§4.1 pill rewrite, §3/§4 reorder, §4.3 reviewer note, S104 caption tweak), then TRG sweep prep. AUG/SEPT PILE (added S106): setup-screen hint-text reword (fill-profile-before-activating contradiction); 222 Logbook-Number-Referred generator question (opaque code vs LL trip id); unlock "How to use LobsterLog" guide row for role 'dfo'. (Existing pile carried: per-uid consent flag [device-global consent]; §22/§25 four passenger PDFs still UNTRACKED; weather display bugs incl. "0.0nd"; FR proofreader pile; off-MAR bycatch/pcons 36-vs-2 [verify-first]; units-label-vs-pref LBS/kg; LFA→ZPH; riding S99 pendings — 6(d) pill walk, P3 admin shown-state, iOS sweep.)