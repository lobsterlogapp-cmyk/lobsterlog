...
export const styles = StyleSheet.create({
    ...
    header: {
        ...
        headerContent: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 8 },
        headerLeft: { flexDirection: 'row', alignItems: 'center', gap: 10, flex: 1, flexShrink: 1 },
        headerIcon: { backgroundColor: 'rgba(255,255,255,0.12)', padding: 0, borderRadius: 6 },
        headerTitle: { color: 'white', fontSize: 18, fontWeight: 'bold' },
        headerSubtitle: { color: '#93C5FD', fontSize: 13 },
        headerRight: { flexDirection: 'row', gap: 4, alignItems: 'center' },
        headerRightStack: { alignItems: 'flex-end' },
        navButton: { padding: 6, borderRadius: 8 },
    navButtonActive: { backgroundColor: '#1E40AF' },
    dfoPillRow: { alignItems: 'flex-end', marginTop: 5 },
    dfoPill: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#DC2626', paddingHorizontal: 14, minHeight: 44, borderRadius: 999, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 3, shadowOffset: { width: 0, height: 1 }, elevation: 2 },
...
// --- Inline styles moved from App.js ---
    resetSeasonButton: {
        flexDirection: 'row',
        alignItems: 'center',
